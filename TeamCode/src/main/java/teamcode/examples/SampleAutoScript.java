...
public class SampleAutoScript extends AbstractOpMode {
    ...
    such as use of the pure pursuit framework and the localizer
     */
    ...
    protected void onInitialize() {
        localizer = new Localizer(hardwareMap, new Point(25, 25), 0);
        ...
        allPoints.add(new CurvePoint(25, 25, 1.0, 0.5, 10, Math.toRadians(50), 1.0));
