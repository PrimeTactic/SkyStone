...
public class Constants {
    ...
    public static final String LEFT_VERTICAL_ODOMETER_NAME = "";
    public static final String RIGHT_VERTICAL_ODOMETER_NAME = "";
    public static final String HORIZONTAL_ODOMETER_NAME = "";
